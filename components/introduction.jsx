                ...
                <div className={styles.group1}>
                    ...
                    <div className={styles.group1_msg}>
                        ...
                        >
                            ...
                            and I convert <i>ideas</i> and <i>creativity</i>{' '}
                        ...
                        >
                            <a
                                ...
                                target="_blank"
                                className={
                                    styles.socialGT + ' ' + styles.tooltip
                                }
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                className={
                                    styles.socialLI + ' ' + styles.tooltip
                                }
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                className={
                                    styles.socialFB + ' ' + styles.tooltip
                                }
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                className={
                                    styles.socialTW + ' ' + styles.tooltip
                                }
                            >
                            ...
                            <a
                                ...
                                className={
                                    styles.socialML + ' ' + styles.tooltip
                                }
                            >
